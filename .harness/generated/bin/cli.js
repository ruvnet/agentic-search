...
// Generated by metaharness — the `agentic-search-agent` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx agentic-search-agent`
...
// "bin" + "files" fields in package.json), so `npx agentic-search-agent` works the moment
...
const HARNESS_NAME = 'agentic-search-agent';

/** `agentic-search-agent init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `agentic-search-agent doctor` — verify the install end-to-end (kernel + host resolve). */
